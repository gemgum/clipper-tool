...
const en = {
  ...
  recheck: "check again",
  pingTest: "Test the model",
  pingBusy: "Greeting the model…",
  ...
  pickParagraph: "Choose paragraph ({n})",
  pickParagraphEmpty: "Choose paragraph",
  analyzing: "Analysing…",
...
const id: Record<MessageKey, string> = {
  ...
  pickParagraph: "Pilih paragraf ({n})",
  pickParagraphEmpty: "Pilih paragraf",
