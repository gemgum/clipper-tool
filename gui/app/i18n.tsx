...
const en = {
  ...
  gridOff: "off",
  gridHint:
    "Dragging snaps to the grid. Hold Alt for free placement, or use the arrow keys to nudge by 1 (Shift = 10).",
  ...
  font: "Font",
  fontOther: "Other font — type it in…",
...
const id: Record<MessageKey, string> = {
  ...
  gridOff: "mati",
  gridHint:
    "Seretan menempel ke grid. Tahan Alt untuk bebas, atau pakai tombol panah untuk menggeser 1 (Shift = 10).",
  ...
  font: "Font",
  fontOther: "Font lain — ketik manual…",
